...
//        String name = nick[3]; (x) 배열의 방법
        ...
        int idx = nick.indexOf("멍멍이");
        System.out.println("멍멍이의 인덱스 : " + idx);

        // clear(): 리스트 내부 요소들 전체 삭제
        nick.clear();
        System.out.println(nick);
        ...
        collecrions는 컬렉션 객체들의 부가 기능들을 지원합니다.
         */
        ...
        // 한번에 객체 많이 추가하기
        Collections.addAll(score,78, 100, 88, 79, 21, 100, 56, 100);
...
//        Collections.reverseOrder(score); 역순배치
